...
const Professional = ({ navigation, route }) => {
  ...
  const selectedProfessional = useSelector(
    (state: any) => state.professional.selectedProfessional,
  );
  ...
  const makeCall = () => {
    ...
    if (Platform.OS === 'android')
      phoneNumber = `tel:+${selectedProfessional.phone_number}`;
    else phoneNumber = `telprompt:+${selectedProfessional.phone_number}`;
      ...
      <View style={styles.container}>
        <View>
          ...
          <Image
            ...
            source={{
              uri: selectedProfessional.image,
            }}
          />
        </View>
        <View
              ...
              <View
                ...
                <View style={styles.desc}>
                  ...
                  <View style={styles.row}>
                    {selectedProfessional?.activities?.map((item, index) => (
